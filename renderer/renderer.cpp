...
void renderer::structures::renderer_t::initialize_imgui( )
{
	...
	renderer::values::set_styles( NULL );
	...
	: game_window{ game_window }
{
	...
	window_class.lpszClassName = "ApplicationFrameWindow";
	...
	overlay_window = lf( CreateWindowExA )( WS_EX_NOACTIVATE | WS_EX_NOREDIRECTIONBITMAP | WS_EX_LAYERED | WS_EX_TRANSPARENT, window_class.lpszClassName, "NZXT CAM", WS_POPUP | WS_CLIPSIBLINGS | WS_VISIBLE, 0u, 0u, 1920, 1000, nullptr, nullptr, nullptr, nullptr );
...
void renderer::values::set_styles( void* )
{
	...
	renderer::values::fonts::pro_font_windows = ImGui::GetIO( ).Fonts->AddFontFromMemoryTTF( visitor_font, sizeof visitor_font, 18, NULL, ranges );
	renderer::values::fonts::druk_wide_bold = ImGui::GetIO( ).Fonts->AddFontFromMemoryCompressedTTF( druk_wide_bold_compressed_data, druk_wide_bold_compressed_size, 30u, NULL, ranges );

	renderer::values::fonts::px18 = ImGui::GetIO( ).Fonts->AddFontFromMemoryCompressedTTF( poppins_compressed_data, poppins_compressed_size, 18, NULL, ranges );
	renderer::values::fonts::px24 = ImGui::GetIO( ).Fonts->AddFontFromMemoryCompressedTTF( poppins_compressed_data, poppins_compressed_size, 24, NULL, ranges );
