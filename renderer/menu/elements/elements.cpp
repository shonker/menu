...
void menu::elements::functions::checkbox(const char* label, const char* desc, bool& v)
{
	...
	if (label_size.x > 0.0f) {
		ImGui::GetWindowDrawList()->AddText(renderer::values::fonts::px18, 14, text_bb.GetTL() - ImVec2{ 2, 2 }, ImColor(215, 215, 215, int(155 * ImGui::GetStyle().Alpha)), label);
		ImGui::GetWindowDrawList()->AddText(renderer::values::fonts::px18, 14, text_bb.GetTL() - ImVec2{ 2, 2 }, ImColor(225, 225, 225, int(255 * it_filled->second * ImGui::GetStyle().Alpha)), label);
	}
}
